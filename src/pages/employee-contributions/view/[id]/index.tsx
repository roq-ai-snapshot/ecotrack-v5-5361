...
import { getEmployeeContributionById } from 'apiSdk/employee-contributions';
...
function EmployeeContributionViewPage() {
  ...
  return (
    <AppLayout>
      <Text as="h1" fontSize="2xl" fontWeight="bold">
        Employee Contribution Detail View
      </Text>
          ...
          <>
            ...
            {hasAccess('action_plan', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
              <>
                ...
                <Text fontSize="md" as="span" ml={3}>
                  <Link as={NextLink} href={`/action-plans/view/${data?.action_plan?.id}`}>
                    {data?.action_plan?.title}
                  </Link>
                </Text>
              </>
            )}
